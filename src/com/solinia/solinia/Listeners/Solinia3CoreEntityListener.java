		...
		Bukkit.getServer().getScheduler().scheduleSyncDelayedTask(StateManager.getInstance().getPlugin(),
				new Runnable() {
					public void run() {
						...
						org.bukkit.craftbukkit.v1_15_R1.entity.CraftLivingEntity cle = ((org.bukkit.craftbukkit.v1_15_R1.entity.CraftLivingEntity) entity);

						if (cle.getHandle() == null)
							return;

						if (cle.getHandle().getAttributeInstance(
								net.minecraft.server.v1_15_R1.GenericAttributes.FOLLOW_RANGE) == null)
							return;

						cle.getHandle()
								.getAttributeInstance(net.minecraft.server.v1_15_R1.GenericAttributes.FOLLOW_RANGE)

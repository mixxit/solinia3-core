...
public class SoliniaCraftFactory {
	public static SoliniaCraft Create(String craftname, int itemid1, int itemid2, int outputitemid) throws CoreStateInitException, SoliniaCraftCreationException {

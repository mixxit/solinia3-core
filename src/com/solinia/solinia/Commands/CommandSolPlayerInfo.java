	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		try
		{
			for (ISoliniaPlayer character : StateManager.getInstance().getPlayerManager().getCharactersByPlayerUUID(playerUUID))
			{
				...
				String details = ChatColor.GOLD + character.getFullNameWithTitle() + " " + charclass + " Level: " + character.getActualLevel() + " AAPtsSpent: " + character.getAAPointsSpent() + locked + ChatColor.RESET;

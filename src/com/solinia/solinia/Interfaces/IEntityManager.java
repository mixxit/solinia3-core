...
public interface IEntityManager {
	...
	void removeSpellEffectsExcept(UUID uuid,  boolean forceDoNotLoopBardSpell, boolean removeNonCombatEffects, List<SpellEffectType> exclude, boolean removeBeneficial);
